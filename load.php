...
$minPrice = 100; // Пример минимальной цены
$maxPrice = 200000; // Пример максимальной цены
...
function getCategoryFilters($data) {
    ...
    foreach ($data as $category => $categoryData) {
        ...
        $result[$category] = ['brands' => $brands, 'attributes' => $attributes, 'minPrice' => $minPrice, 'maxPrice' => $maxPrice];
    }
