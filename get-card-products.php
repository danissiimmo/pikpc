...
// Извлекаем значение name из CategoryDTO
$categoryName = $input['CategoryDTO']['Name'] ?? '';

if (empty($categoryName)) {
    echo json_encode(['error' => 'Параметр CategoryDTO.Name не указан.']);
    exit;
}

// SQL-запрос для получения данных из таблицы products с фильтром по categoryname
$sql = "SELECT * FROM products WHERE categoryname = ?";
